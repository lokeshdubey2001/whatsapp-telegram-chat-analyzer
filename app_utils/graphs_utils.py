...
def generate_geo_piehart(df, language='en',top_n=10):
    ...
    title_lang_dict = {'en': 'Country Share by Locations'}
...
def generate_piechart(df, language='en', top_n=10):
    if not df.empty:
        username_text = {'en': 'Username'}
        other_text = {'en': 'Other'}
        messages_text = {'en': '% of Messages'}
        plot_title = {'en': 'Messages Share by Username'}
...
def generate_activity_overtime(df, min_date, max_date, language='en', unit='Messages', granularity='month'):
    ...
    unit_lan_dict = {"en": {'Messages': 'Messages', 'Users': 'Users'}}
    granularity_lan_dict = {
...
def generate_users_activity_overtime(df, min_date, max_date, language='en', granularity='month',top_n=5):
    if not df.empty:
        granularity_lan_dict = {
                                'en': {'month': 'month', 'week': 'week', 'date': 'day'}}
        messages_lang_dict = {'en': '# of Messages'}
        username_lang_dict = {'en': 'Username'}
        plot_title = {'en': 'Users Activity Over Time (Top %s)'}
...
def generate_hourly_activity(df, language='en'):
    ...
    xaxis_lang_dict = {'en': "Hour of day"}
    yaxis_lang_dict = {'en': "% of Activity"}
    title_lang_dict = {'en': 'Activity by Hour of Day'}
...
def generate_day_of_week_activity(df, language='en'):
    ...
    yaxis_lang_dict = {'en': "Day of Week"}
    xaxis_lang_dict = {'en': "% of Activity"}
    title_lang_dict = {'en': 'Activity by Day of Week'}
...
def generate_activity_matrix(df, language='en'):
    ...
    title_lang_dict = {'en': 'Message Distribution by Day and Hour'}
...
def generate_message_responses_flow(df, language='en', n_users=5):
    ...
    title_lang_dict = {'en': f'Message flow (Top {n_users})'}
