...
def get_summarizer_df(filtered_df, language):
    ...
    with sum_text_col1:
        summrizer_title_lang_dict = {'en': 'Conversations Summarizer (Beta)'}
        ...
        date_selector_lng_dict = {'en': 'Select a Date'}
        month_selector_lng_dict = {'en': 'Select a Month'}
        conf_filed_lan_dict = {'en': 'Conversation'}
        ...
        with filter_col2:
            conv_selector_lang_dict = {'en': 'Select a Conversation'}
            all_lang_dict = {'en': 'All'}
        ...
        with button_col:
            button_lang_dict = {'en': 'Summarize Conversations'}
            st.write('')
            st.write('')
        ...
        orig_text_lang_dict = {'en': "Original Conversation"}
        ...
        with col3:
            sum_text_lang_dict = {'en': "Summarized Conversation"}
...
def get_trends_explorer_widgets(filtered_df, min_date, max_date, language):
    ...
    with global_col:
        explorer_title_lang_dict = {'en': 'Trends Analysis'}
        st.subheader(explorer_title_lang_dict[language])

        st.divider()

        text_input_lang = {'en': "Filter by text"}
        ...
        with col1:
            ...
            with tab_0:
                gran_lang_dict = {'en': ["Monthly", "Weekly", "Daily"]}
...
def get_sentiment_widget(filtered_df, language, max_words=30, max_messages=300, sample_size=0.2):
    ...
    with global_col:
        ...
        st.divider()
        text_input_lang = {'en': "Select Term"}
...
def main():
    ...
    if 'data' not in st.session_state:
        ...
        global_title_lang_dict = {'en': 'Text Analysis (NLP)'}
