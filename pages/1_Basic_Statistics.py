...
def main():
    ...
    if 'data' not in st.session_state:
        ...
        with col5:
            unit_lang_dict = {'en': ("Messages", "Users")}
            unit_dict = {"Messages": "Messages", "Users": "Users"}
            unit_lan_title = {'en': "Messages / Users"}
